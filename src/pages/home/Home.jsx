    ...
    <>
      <div className="flex flex-col w-full h-[100dvh] text-gray-300">
        ...
        <div className="w-full grow grid grid-cols-4 gap-3 bg-[#212121] font-bold p-3 text-2xl">
          <div className="flex justify-center items-center bg-[#f22222] rounded-xl sm:cursor-pointer hover:bg-[#484848]">
            AC
          </div>
          <div className="flex justify-center items-center bg-[#323232] rounded-xl sm:cursor-pointer hover:bg-[#484848]">
            ( )
          </div>
          <div className="flex justify-center items-center bg-[#323232] rounded-xl sm:cursor-pointer hover:bg-[#484848]">
            %
